...
# Apache Spark
+ 1.[What are the main features of Apache Spark?](#What-are-the-main-features-of-Apache-Spark)
+ 2.[What is a Resilient Distribution Dataset in Apache Spark?](#What-is-a-Resilient-Distribution-Dataset-in-Apache-Spark)
+ 3.[What is a Transformation in Apache Spark?](#What-is-a-Transformation-in-Apache-Spark)
+ 4.[What are security options in Apache Spark?](#What-are-security-options-in-Apache-Spark)
+ 5.[How will you monitor Apache Spark?](#How-will-you-monitor-Apache-Spark)
+ 6.[What are the main libraries of Apache Spark?](#What-are-the-main-libraries-of-Apache-Spark)
+ 7.[What are the main functions of Spark Core in Apache Spark?](#What-are-the-main-functions-of-Spark-Core-in-Apache-Spark)
+9. [How will you do memory tuning in Spark?](#How-will-you-do-memory-tuning-in-Spark)
+ 10.[What are the two ways to create RDD in Spark?](#What-are-the-two-ways-to-create-RDD-in-Spark)
+ 11.[What are the main operations that can be done on a RDD in Apache Spark?](#What-are-the-main-operations-that-can-be-done-on-a-RDD-in-Apache-Spark)
+ 12.[What are the common Transformations in Apache Spark?](#What-are-the-common-Transformations-in-Apache-Spark)
+ 13.[What are the common Actions in Apache Spark?](#What-are-the-common-Actions-in-Apache-Spark)
+ 14.[What is a Shuffle operation in Spark?](#What-is-a-Shuffle-operation-in-Spark)
+ 15.[What are the operations that can cause a shuffle in Spark?](#What-are-the-operations-that-can-cause-a-shuffle-in-Spark)
+ 16.[What is purpose of Spark SQL?](#What-is-purpose-of-Spark-SQL)
+17.[What is a DataFrame in Spark SQL?](#What-is-a-DataFrame-in-Spark-SQL)
+ 18.[What is a Parquet file in Spark?](#What-is-a-Parquet-file-in-Spark)
+ 19.[What is the difference between Apache Spark and Apache Hadoop MapReduce?](#What-is-the-difference-between-Apache-Spark-and-Apache-Hadoop-MapReduce)
+ 20[What are the main languages supported by Apache Spark?](#What-are-the-main-languages-supported-by-Apache-Spark)
+ 21[What are the file systems supported by Spark?](#What-are-the-file-systems-supported-by-Spark)
+ 22[What is a Spark Driver?](#What-is-a-Spark-Driver)
+ 23[What is an RDD Lineage?](#What-is-an-RDD-Lineage)
+24 [What are the two main types of Vector in Spark?](#What-are-the-two-main-types-of-Vector-in-Spark)
+ 25[What are the different deployment modes of Apache Spark?](#What-are-the-different-deployment-modes-of-Apache-Spark)
+ 26[What is lazy evaluation in Apache Spark?](#What-is-lazy-evaluation-in-Apache-Spark)
+ 27[What are the core components of a distributed application in Apache Spark?](#What-are-the-core-components-of-a-distributed-application-in-Apache-Spark)
+ 28[What is the difference in cache() and persist() methods in Apache Spark?](#What-is-the-difference-in-cache()-and-persist()-methods-in-Apache-Spark)
+29 [How will you remove data from cache in Apache Spark?](#How-will-you-remove-data-from-cache-in-Apache-Spark)
+ 30[What is the use of SparkContext in Apache Spark?](#What-is-the-use-of-SparkContext-in-Apache-Spark)
+ 31.[Do we need HDFS for running Spark application?](#Do-we-need-HDFS-for-running-Spark-application)
+ 32.[What is Spark Streaming?](#What-is-Spark-Streaming)
+33. [How does Spark Streaming work internally?](#How-does-Spark-Streaming-work-internally)
+ 34.[What is a Pipeline in Apache Spark?](#What-is-a-Pipeline-in-Apache-Spark)
+35. [How does Pipeline work in Apache Spark?](#How-does-Pipeline-work-in-Apache-Spark)
...
+26. [What are the different types of Cluster Managers in Apache Spark?](#What-are-the-different-types-of-Cluster-Managers-in-Apache-Spark)
...
+ 37.[What is the main use of MLib in Apache Spark?](#What-is-the-main-use-of-MLib-in-Apache-Spark)
+ 38.[What is the Checkpointing in Apache Spark?](#What-is-the-Checkpointing-in-Apache-Spark)
+ 39.[What is an Accumulator in Apache Spark?](#What-is-an-Accumulator-in-Apache-Spark)
+ 40.[What is a Broadcast variable in Apache Spark?](#What-is-a-Broadcast-variable-in-Apache-Spark)
+41. [What is Structured Streaming in Apache Spark?](#What-is-Structured-Streaming-in-Apache-Spark)
+42. [How will you pass functions to Apache Spark?](#How-will-you-pass-functions-to-Apache-Spark)
+43. [What is a Property Graph?](#What-is-a-Property-Graph)
+44. [What is Neighborhood Aggregation in Spark?](#What-is-Neighborhood-Aggregation-in-Spark)
+45. [What are different Persistence levels in Apache Spark?](#What-are-different-Persistence-levels-in-Apache-Spark)
+46. [How will you select the storage level in Apache Spark?](#How-will-you-select-the-storage-level-in-Apache-Spark)
+47. [What are the options in Spark to create a Graph?](#What-are-the-options-in-Spark-to-create-a-Graph)
+48. [What are the basic Graph operators in Spark?](#What-are-the-basic-Graph-operators-in-Spark)
+49. [What is the partitioning approach used in GraphX of Apache Spark?](#What-is-the-partitioning-approach-used-in-GraphX-of-Apache-Spark)
+ 50.[What is RDD?](#What-is-RDD)
+51. [Name the different types of RDD](#Name-the-different-types-of-RD)
+ 52.[What are the methods of creating RDDs in Spark?](#What-are-the-methods-of-creating-RDDs-in-Spark)
+ 53.[What is a Sparse Vector?](#What-is-a-Sparse-Vector)
+54. [What are the languages supported by Apache Spark and which is the most popular one, What is JDBC and why it is popular?](#What-are-the-languages-supported-by-Apache-Spark-and-which-is-the-most-popular-one,-What-is-JDBC-and-why-it-is-popular)
+55. [What is Yarn?](#What-is-Yarn)
+56. [Do you need to install Spark on all nodes of Yarn cluster? Why?](#Do-you-need-to-install-Spark-on-all-nodes-of-Yarn-cluster?-Why)
+57. [Is it possible to run Apache Spark on Apache Mesos?](#Is-it-possible-to-run-Apache-Spark-on-Apache-Mesos)
+58. [Define Partitions in Apache Spark](#Define-Partitions-in-Apache-Spar)
+59. [What is a DStream?](#What-is-a-DStream)
+60. [What is a Catalyst framework?](#What-is-a-Catalyst-framework)
+61. [What are Actions in Spark?](#What-are-Actions-in-Spark)
+62. [What is a Parquet file?](#What-is-a-Parquet-file)
+63. [What is GraphX?](#What-is-GraphX)
+64. [What file systems does Spark support?](#What-file-systems-does-Spark-support)
+ 65.[What are the different types of transformations on DStreams? Explain.](#What-are-the-different-types-of-transformations-on-DStreams?-Explain)
+66. [What is the difference between persist () and cache ()?](#What-is-the-difference-between-persist-()-and-cache-())
+67. [What do you understand by SchemaRDD?](#What-do-you-understand-by-SchemaRDD)
+68. [What is Apache Spark?](#What-is-Apache-Spark)
+69. [Explain key features of Spark.](#Explain-key-features-of-Spark)
  70 [Define RDD?](#Define-RDD)
+ 71.[What does a Spark Engine do?](#What-does-a-Spark-Engine-do)
+ 72.[Define Partitions?](#Define-Partitions)
+ 73.[What do you understand by Transformations in Spark?](#What-do-you-understand-by-Transformations-in-Spark)
+ 74.[Define Actions.](#Define-Actions)
